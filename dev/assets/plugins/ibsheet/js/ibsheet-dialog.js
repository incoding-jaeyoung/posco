...
/* 피벗 다이얼로그 생성 메소드 */
Fn.createPivotDialog = function (width, height, name, showType, pivotParams) {
  // 스타일이 중복 되었을때 스타일을 제거한다.
  ...
  var pivotTypes = self.producePivotTypes(pivotType);
...
Fn.showPivotDialog = Fn.createPivotDialog;
